...
def main(x_start=0,y_start=0,x_end=0,y_end=10):
    Read_in_warehouse()
    print"Welcome to the warehouse order management system!"
    print"Do you want to use the default start location at (0,0) and end at (0,10)?"
    ...
    print"Input 1 if you want to input order directly,Input 2 if you want to input a order file:"
    version=input()
